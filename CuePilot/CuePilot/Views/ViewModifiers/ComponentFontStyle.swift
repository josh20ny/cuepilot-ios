...
private struct ComponentFontStyle: EnvironmentKey {
    static let defaultValue: FontStyle = .body
}

public extension EnvironmentValues {
    var componentFontStyle: FontStyle {
        get { self[ComponentFontStyle.self] }
        set { self[ComponentFontStyle.self] = newValue }
    }
}
...
public extension View {
    ...
    func componentFontStyle(_ style: FontStyle) -> some View {
        environment(\.componentFontStyle, style)
    }
}
